...
const (
	Operator_DCSubmit_FullMethodName = "/rpc.Operator/DCSubmit"
)
...
func (c *operatorClient) DCSubmit(ctx context.Context, in *DCRequest, opts ...grpc.CallOption) (*DCReply, error) {
	out := new(DCReply)
	err := c.cc.Invoke(ctx, Operator_DCSubmit_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Operator_DCSubmit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Operator_DCSubmit_FullMethodName,
	}
...
const (
	OperatorFeatures_DCSubmitFeatures_FullMethodName = "/rpc.OperatorFeatures/DCSubmitFeatures"
)
...
func (c *operatorFeaturesClient) DCSubmitFeatures(ctx context.Context, in *DCRequest, opts ...grpc.CallOption) (OperatorFeatures_DCSubmitFeaturesClient, error) {
	stream, err := c.cc.NewStream(ctx, &OperatorFeatures_ServiceDesc.Streams[0], OperatorFeatures_DCSubmitFeatures_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
