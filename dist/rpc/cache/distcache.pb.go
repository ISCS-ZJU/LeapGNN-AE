...
type DCRequest struct {
	...
	Idx int64 `protobuf:"varint,1,opt,name=idx,proto3" json:"idx,omitempty"` // graph node idx
}
...
type DCReply struct {
	...
	Feature []float32 `protobuf:"fixed32,1,rep,packed,name=feature,proto3" json:"feature,omitempty"` // features of one idx
}
...
var file_distcache_proto_rawDesc = []byte{
	...
	,
...
var file_distcache_proto_goTypes = []interface{}{
	(*DCRequest)(nil), // 0: rpc.DCRequest
	(*DCReply)(nil),   // 1: rpc.DCReply
}
var file_distcache_proto_depIdxs = []int32{
	0, // 0: rpc.Operator.DCSubmit:input_type -> rpc.DCRequest
	1, // 1: rpc.Operator.DCSubmit:output_type -> rpc.DCReply
