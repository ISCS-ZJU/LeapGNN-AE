...
client_cmd_lst = [
    ...
    # 'python3 clients_start.py --model_name gat --sampling 5-5 --run_client_idx 9 --dataset ogbn_arxiv0 --n_epochs 3 --batch_size 1024 --hidden_size 16 --iter_stop 5',
    # 'python3 clients_start.py --model_name gat --sampling 5-5 --run_client_idx 9 --dataset ogbn_arxiv0 --n_epochs 3 --batch_size 1024 --hidden_size 32 --iter_stop 5',
