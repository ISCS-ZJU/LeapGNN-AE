...
trans_num={
'gat_in_2004_4096_16' : 2441237760,
'gat_in_2004_4096_32' : 2940260368,
'gat_ogbn_arxiv0_2048_16' : 220339680,
'gat_ogbn_arxiv0_2048_32' : 269810400,
'gat_ogbn_products0_8000_16' : 26723498032,
'gat_ogbn_products0_8000_32' : 31421533504,
'gat_uk_2007_4096_16' : 2678662128,
'gat_uk_2007_4096_32' : 3205203744,
'gcn_in_2004_4096_16' : 2113881492,
'gcn_in_2004_4096_32' : 2410794564,
'gcn_ogbn_arxiv0_2048_16' : 182544216,
'gcn_ogbn_arxiv0_2048_32' : 213424008,
'gcn_ogbn_products0_8000_16' : 24187979224,
'gcn_ogbn_products0_8000_32' : 26655670200,
'gcn_uk_2007_4096_16' : 2393780256,
'gcn_uk_2007_4096_32' : 2675795680,
'graphsage_in_2004_4096_16' : 2143243976,
'graphsage_in_2004_4096_32' : 2453622056,
'graphsage_ogbn_arxiv0_2048_16' : 180675888,
'graphsage_ogbn_arxiv0_2048_32' : 218615600,
'graphsage_ogbn_products0_8000_16' : 24479555504,
'graphsage_ogbn_products0_8000_32' : 25957320272,
'graphsage_uk_2007_4096_16' : 2452210720,
'graphsage_uk_2007_4096_32' : 2708202208,
}
        ...
        with torch.autograd.profiler.record_function('total epochs time'):
            for epoch in range(args.epoch):
                ...
                for nf in sampler:
                    ...
                    num = 100
                    for i in range(num):
                        val = torch.rand(trans_num[f"{args.model_name}_{ args.dataset.strip('/').split('/')[-1]}_{args.batch_size}_{args.hidden_size}"]//55//num)
                        new_val = torch.zeros_like(val)
