...
# python3 simulate/obsv1/dgl_default_layerwise_sampling_simulate_avoid_oom.py -bs 1 -ep 1 --world-size 16 --sampling 2-2-2-2-2-2-2-2-2 -d ./dist/repgnn_data/ogbn_products0/ --ls-lst [50,50,50,50,50,50,50,50,50,1]
